...
public class AddTeacher_JInternalFrame extends JInternalFrame
{
	...
	/*public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				try
				{
					AddTeacher_JInternalFrame frame = new AddTeacher_JInternalFrame();
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
						...
						.addComponent(lblTelephone, Alignment.LEADING)
						...
						.addComponent(lblClassName, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
								...
								.addComponent(TeacherPassword_PasswordField)
								.addComponent(TeacherName_TextField)
								.addComponent(TeacherTitle_TextField)
								.addComponent(TeacherTelephone_TextField))
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblId)
						.addComponent(TeacherID_TextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(34)
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblName)
						.addComponent(TeacherName_TextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(41)
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblPassword)
						.addComponent(TeacherPassword_PasswordField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(35)
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(ChooseClassName_JComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblClassName))
					.addGap(35)
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblNewLabel)
						.addComponent(TeacherAge_TextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(34)
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblAge)
						.addComponent(TeacherSex_Male_JRadioButton)
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(TeacherTitle_TextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(38)
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblTelephone)
						.addComponent(TeacherTelephone_TextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
	...
	protected void Function_AddTeacher(ActionEvent e)
	{
		...
		int teacherAge ;
		//So simple ! (っ•̀ω•́)っ✎⁾⁾  ~
		String teacherSex = TeacherSex_Male_JRadioButton.isSelected() ? TeacherSex_Male_JRadioButton.getText() : TeacherSex_Female_JRadioButton.getText();
		...
		if(StringUtil.IsEmpty(teacherID)||StringUtil.IsEmpty(teacherName)||StringUtil.IsEmpty(teacherPassword)
				||StringUtil.IsEmpty(TeacherAge_TextField.getText().toString())
					||StringUtil.IsEmpty(teacherTitle)||StringUtil.IsEmpty(teacherTelephone))
		{
